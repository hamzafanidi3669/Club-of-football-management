    ...
    <nav class="navbar navbar-expand-lg navnav row">
        ...
        <div class="col-8 jam3ali ">
          ...
          <ul class="navbar-nav text-center mr-auto naveul">
            ...
            <li class="nav-item {{ request()->is('allacademynews') ? 'active' : '' }}">
              <a class="nav-link nava"  href="allacademynews">ACADEMY</a>
            </li>
            <li class="nav-item {{ request()->is('fixtures') ? 'active' : '' }}">
              <a class="nav-link nava" href="fixtures">FIXTURES&TEAMS</a>
            </li>
      ...
      @if (Route::has('login'))
        ...
        @auth
            ...
            <div class="nav-item   join">
              <a href="allusers" class="nav-link joinm">
                <img src="img/utilisateur.png" width="15px" height="15px" alt="" class="navuser">
 
                <span class="joinlink  nava">ACCOUNTS</span>
            ...
            @else
            <div class="nav-item   join">
              <a href="{{ url('/profile') }}" class="nav-link joinm">
                <img src="img/utilisateur.png" width="15px" height="15px" alt="" class="navuser">
...
<br> <br>
      ...
      <nav class="nav-bar2">
        <ul class="ul2 navul">
          <li>
            <a href="allnews" class="nava testnewsnav2 @if(Request::is('news')) active @endif">News</a>
          </li>
          <li>
            <a href="allacademynews" class="nava @if(Request::is('news')) active @endif">Academy</a>
          </li>
          <li>
            <a href="fixtures" class="nava @if(Request::is('news')) active @endif">Fixtures&Teams</a>
          </li>
          <li>
            <a href="tickets" class="nava @if(Request::is('news')) active @endif">Tickets</a>
          </li>
          <li>
            <a href="store" class="nava @if(Request::is('news')) active @endif">Store</a>
          </li>
        </ul>
      </nav>
