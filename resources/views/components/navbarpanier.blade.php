...
<head>
    ...
    <link rel="stylesheet" href="stylenavpanier.css">
    <style>
        ...
        <div class="col-8 jam3ali ">
          ...
          <ul class="navbar-nav text-center mr-auto naveul">
            ...
            <li class="nav-item {{ request()->is('fixturesteams') ? 'active' : '' }}">
              <a class="nav-link nava" href="fixturesteams">FIXTURES&TEAMS</a>
            </li>
...
{{-- 
      @if (Route::has('login'))
        ...
        @auth
            ...
            <div class="nav-item col-6 join">
              <a href="{{ url('/dashboard') }}" class="nav-link joinm row">
                <img src="img/utilisateur.png" width="15px" height="15px" alt="" class="navuser col-6 bg-secondary">
 
                <span class="joinlink  nava accountpanier col-1">ACCOUNT</span>

              </a>
            </div>

          <div class="nav-item col-6 login">
              <a href="{{ url('/logout') }}" class="nav-link navloginlink nava accountpanier">LOGOUT</a>
          </div>
        @else
 ...
 <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
  <div class="flex justify-between h-16">
      <div class="flex" >
          <!-- Logo -->
          <div class="shrink-0 flex testgridpanier items-center">
              <a href="affpanier" class="shoppinglinkdashboard">
          ...
          <!-- Navigation Links -->
          <div class="hidden space-x-8 testbtnpanier sm:-my-px sm:ml-10 sm:flex">
              <x-nav-link class="xnavlink" :href="route('affpanier')" :active="request()->routeIs('affpanier')">
                  {{ __('Votre Panier') }}
              </x-nav-link>
          </div>
      </div>
