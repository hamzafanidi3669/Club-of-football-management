    ...
    <div class="contenttickets">
        <div class="linkmestickets">
            @if(Auth::check())
                ...
                @else
                    <a href="mestickets">mestickets</a>
                @endif
        ...
        <form action="acheterticket?id={{$matche->id}}" method="post">
            ...
            <div class="divticket row">
                <div class="textticket col-8">
                    ...
                    <input type="number" min="1" max="5"  placeholder="Quantite" class="quantite_commadetickets" name="quantite_ticket_{{$matche->id}}"> <br>
                    @error('quantite_ticket_'.$matche->id)
